...
import { eventTypeIcon, eventTypeLabel, daysUntilLabel, daysUntil } from '../utils/reminderEngine';

export default function ReminderItem({ reminder }) {
    const days = daysUntil(reminder.event_date);
    return (<Link to={`/reminders/${reminder.id}`} className="dash-reminder-link">
